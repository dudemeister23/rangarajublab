...
const Navbar: React.FC = () => {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-white/95 backdrop-blur-md shadow-md py-4' : 'bg-slate-900/20 backdrop-blur-sm py-6 border-b border-white/10'
        }`}
    >
      <div className="container mx-auto px-6 md:px-12 flex justify-between items-center">
        {/* Logo */}
        <a href="#home" className="flex items-center gap-4 group">
          <div className="h-14 w-auto flex items-center justify-center transition-all duration-300">
            <img
              src={LAB_LOGO}
