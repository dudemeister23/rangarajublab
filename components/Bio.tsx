        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center justify-center">
          ...
          <div className="w-full lg:w-2/5">
            ...
            <div className="prose prose-lg text-slate-600 leading-relaxed text-justify">
              <p className="mb-4">
                Dr. Vidhya Rangaraju started her <a href="https://mpfi.org/science/our-labs/rangaraju-lab/" target="_blank" rel="noopener noreferrer" className="bio-link">Research Group Leader position</a> at the <a href="https://mpfi.org" target="_blank" rel="noopener noreferrer" className="bio-link">Max Planck Florida Institute for Neuroscience</a> in January 2020. The overarching goal of the Rangaraju group is to investigate the energy use and supply of biological processes in neurons.
              </p>
              <p className="mb-4">
                Prior to this appointment, Rangaraju was an <a href="https://www.embo.org/funding/fellowships-grants-and-career-support/postdoctoral-fellowships/" target="_blank" rel="noopener noreferrer" className="bio-link">EMBO</a> and <a href="https://marie-sklodowska-curie-actions.ec.europa.eu/actions/postdoctoral-fellowships" target="_blank" rel="noopener noreferrer" className="bio-link">Marie Curie Postdoctoral Fellow</a> in the group of <a href="https://brain.mpg.de/schuman" target="_blank" rel="noopener noreferrer" className="bio-link">Dr. Erin Schuman</a> at the <a href="https://brain.mpg.de/home" target="_blank" rel="noopener noreferrer" className="bio-link">Max Planck Institute for Brain Research</a> in Germany. During her postdoc, <a href="https://www.sciencedirect.com/science/article/pii/S0092867418316271?via%3Dihub" target="_blank" rel="noopener noreferrer" className="bio-link">she uncovered the presence of local mitochondrial compartments of energy that fuel local translation during synaptic plasticity.</a>
              </p>
              <p className="mb-4">
