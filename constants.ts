...
export const NEWS_ITEMS: NewsItem[] = [
  ...
  },
  {
    ...
    content: 'Dr. Vidhya Rangaraju is featured in two new South Florida PBS Health Channel programs released this month: the documentary The Resilient Brain and the town hall Memory & the Mind: What Science Tells Us About Brain Health. Together, the specials place the Rangaraju Lab\'s work on neuroenergetics alongside leading voices from Columbia, Mount Sinai, the University of Miami, FAU, and Wertheim UF Scripps in a wide-ranging conversation about how the brain adapts, remembers, and recovers.\n\nIn the Memory & the Mind town hall, hosted by Pam Giganti, Dr. Rangaraju joins Daphna Shohamy, PhD (Director & CEO, Zuckerman Institute, Columbia University) and Paul Kenny, PhD (Director, The Friedman Brain Institute, Mount Sinai) to discuss memory, cognitive aging, and brain resilience. Dr. Rangaraju draws on the lab\'s research to explain how mitochondria fuel synaptic plasticity, and underscores the everyday levers that protect long-term brain health: "Sleep is very important. It\'s important to consolidate memories, clear waste, and recharge the mitochondria so that brain cells can be healthy."\n\nThe Resilient Brain documentary broadens the lens to the full arc of brain adaptability — from veterans recovering from traumatic brain injuries to children with rare neurological conditions and older adults navigating Parkinson\'s and Alzheimer\'s — framing resilience as both a biological and emotional force, and connecting it to lifestyle factors that support prevention.\n\nBoth programs are produced by the South Florida PBS Health Channel and stream at AllHealthTV.com, with broadcast on the Health Channel, WPBT (Miami/Fort Lauderdale), and WXEL (West Palm Beach). The full press release is available below.'
  },
  {
    id: 'n17',
  ...
  },
  {
    ...
    category: 'Award',
    externalLink: 'https://www.sfn.org/careers/awards/early-career/janett-rosenberg-trubatch-career-development-award',
  ...
  },
  {
    ...
    category: 'Award',
    externalLink: 'https://chanzuckerberg.com/science/programs-resources/neurodegeneration-challenge/projects/?award=ben-barres-cycle-2',
...
export const ALUMNI_DATA: AlumniGroup[] = [
  {
    ...
    members: [
      ...
      { id: 'al3', name: 'Rasya Bhat', labRole: "Master's Student", details: 'MS at MPFI\nResearch Assistant at CHINTA', image: 'assets/alumni/rasya_bhat.jpg', scale: 1.2, email: 'rasya.bhat@student.uni-tuebingen.de' },
